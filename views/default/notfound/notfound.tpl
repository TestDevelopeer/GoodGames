...
<head>
    ...
    <!-- jQuery -->
    <script src="{$teplateWebPath}assets/vendor/jquery/dist/jquery.min.js"></script>
...
<div class="nk-fullscreen-block">
    <div class="nk-fullscreen-block-top">
        <div class="text-center">
            ...
            <a href="index.html"><img src="{$teplateWebPath}assets/images/logo-2.png" alt="GoodGames"></a>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4">
                    ...
                    <h2 class="h4">Кажется вы свернули не туда!</h2>

                    <div>или данной страницы не существует... <br> Попробуйте вернутся на главную страницу</div>
                    <div class="nk-gap-3"></div>

                    <a href="/" class="nk-btn nk-btn-rounded nk-btn-color-white">На главную</a>
                </div>
            </div>
            <div class="nk-gap-3"></div>
        </div>
    ...
    <div class="nk-page-background-fixed" style="background-image: url('{$teplateWebPath}assets/images/bg-fixed-2.jpg');"></div>
...
<script src="{$teplateWebPath}assets/vendor/gsap/src/minified/plugins/ScrollToPlugin.min.js"></script>
...
<script src="{$teplateWebPath}assets/vendor/jarallax/dist/jarallax-video.min.js"></script>

<!-- imagesLoaded -->
<script src="{$teplateWebPath}assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
...
<script src="{$teplateWebPath}assets/vendor/moment-timezone/builds/moment-timezone-with-data.min.js"></script>

<!-- Hammer.js -->
<script src="{$teplateWebPath}assets/vendor/hammerjs/hammer.min.js"></script>

<!-- NanoSroller -->
<script src="{$teplateWebPath}assets/vendor/nanoscroller/bin/javascripts/jquery.nanoscroller.js"></script>

<!-- SoundManager2 -->
<script src="{$teplateWebPath}assets/vendor/soundmanager2/script/soundmanager2-nodebug-jsmin.js"></script>
...
<!-- nK Share -->
<script src="{$teplateWebPath}assets/plugins/nk-share/nk-share.js"></script>
