<?php
/* Smarty version 3.1.30, created on 2019-02-09 21:33:12
  from "D:\OSPanel\domains\games\views\default\user\profile.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5c5f1ce8e680a1_95744077',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '848669ca94b85224c35b61d0702bc2fb108c9b91' => 
    array (
      0 => 'D:\\OSPanel\\domains\\games\\views\\default\\user\\profile.tpl',
      1 => 1549737191,
      2 => 'file',
    ),
  ),
...
function content_5c5f1ce8e680a1_95744077 (Smarty_Internal_Template $_smarty_tpl) {
?>
               ...
               <div class="profile_header_content">
                  <div class="profile_header_centered_persona">
                     ...
                     <div class="header_real_name ellipsis">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['rsUser']->value['user_country'] != '') {
echo $_smarty_tpl->tpl_vars['rsUser']->value['user_country'];
}?>, <?php if ($_smarty_tpl->tpl_vars['rsUser']->value['user_city'] != '') {
echo $_smarty_tpl->tpl_vars['rsUser']->value['user_city'];
}?>                  
                     </div>
                  </div>
...
users/default/default.png">
                  ...
                  <div class="profile_header_badgeinfo">
                     <div class="profile_header_actions">
                        <a class=" btn_profile_action btn_medium" <?php if ($_smarty_tpl->tpl_vars['rsUser']->value['user_link'] == '') {?> href="/user/edit/<?php echo $_smarty_tpl->tpl_vars['rsUser']->value['id_user'];?>
/" <?php } else { ?> href="/user/edit/<?php echo $_smarty_tpl->tpl_vars['rsUser']->value['user_link'];?>
/" <?php }?>>
                  ...
                  <div class="profile_header_badgeinfo">
                     <div class="profile_header_actions">
                        <a class=" btn_profile_action btn_medium" href="/user/edit/<?php echo $_smarty_tpl->tpl_vars['rsUser']->value['id_user'];?>
/">
                  ...
                  <div class="profile_header_summary">
                     ...
                     <div class="profile_summary noexpand">
                        <?php if ($_smarty_tpl->tpl_vars['rsUser']->value['user_desc'] != '') {
echo $_smarty_tpl->tpl_vars['rsUser']->value['user_desc'];
} else { ?>Информация отсутствует.<?php }?>                       
                     </div>
                     <div class="profile_summary_footer" style="display: none;">
                        <span class="whiteLink">Подробнее</span>
                     </div>
                     <?php echo '<script'; ?>
 type="text/javascript"> $J( function() { InitProfileSummary( g_rgProfileData['summary'] ); } ); <?php echo '</script'; ?>
>
                  </div>
               </div>
            </div>
...
assets/images/avatar-2.jpg" alt="Witch Murder" class="rounded-circle" width="35"> by <a href="https://nkdev.info">Witch Murder</a> in 20 September, 2018
                                 </div>
