<?php
/* Smarty version 3.1.30, created on 2019-01-21 23:42:15
  from "D:\OSPanel\domains\games\views\default\latestNews.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5c462ea79e5312_54522773',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '67631fd49f743f88327041926b4c1d0f98cc0031' => 
    array (
      0 => 'D:\\OSPanel\\domains\\games\\views\\default\\latestNews.tpl',
      1 => 1548103330,
      2 => 'file',
    ),
  ),
...
function content_5c462ea79e5312_54522773 (Smarty_Internal_Template $_smarty_tpl) {
?>
    <!-- START: Latest News -->
...
assets/images/post-1-sm.jpg" alt="Smell magic in the air. Or maybe barbecue">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-1.jpg" alt="Smell magic in the air. Or maybe barbecue" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-2-sm.jpg" alt="Grab your sword and fight the Horde">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-2.jpg" alt="Grab your sword and fight the Horde" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-3-sm.jpg" alt="We found a witch! May we burn her?">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-3.jpg" alt="We found a witch! May we burn her?" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-4-sm.jpg" alt="For good, too though, in consequence">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-4.jpg" alt="For good, too though, in consequence" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-5-sm.jpg" alt="He made his passenger captain of one">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-5.jpg" alt="He made his passenger captain of one" class="nk-news-box-item-full-img">
                    ...
                    <div class="nk-news-box-item">
                        <div class="nk-news-box-item-img">
                            <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-6-sm.jpg" alt="At first, for some time, I was not able to answer">
                        </div>
                        <img src="<?php echo $_smarty_tpl->tpl_vars['teplateWebPath']->value;?>
assets/images/post-6.jpg" alt="At first, for some time, I was not able to answer" class="nk-news-box-item-full-img">
