...
function loadPage($smarty, $controllerName, $actionName = 'index') {
    if($controllerName == 'Admin' || $controllerName == 'Function' || $controllerName == 'Login' || $controllerName == 'Editgame' || $controllerName == 'Editarticle'){
        include_once PathPrefixAdmin . $controllerName . PathPostfix;
    } else {
